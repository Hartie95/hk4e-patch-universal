...
const KEY_SIGN_CHECK: &str = "48 89 5C 24 10 48 89 6C 24 18 56 48 83 EC 30 48 8B 05 8A 27 57 07 48 8B D9 49 8B F0 48 8B EA 4C 8B 88 B8 00 00 00 49 8B 49 18 48 85 C9 0F 85 59 01 00 00 48 8B 05 C6 7A 57 07 48 8B 80 B8 00 00 00 48 8B 48 10 48 85 C9 75 1D 48 8B 00 81 78 18";
const VERIFY_DATA: &str = "48 89 5C 24 10 48 89 6C 24 18 56 48 83 EC 30 48 8B 05 2A 2C 57 07 48 8B D9 49 8B F0 48 8B EA 4C 8B 88 B8 00 00 00 49 8B 49 20 48 85 C9 0F 85 51 01 00 00 48 8B 05 66 7F 57 07 48 8B 80 B8 00 00 00 48 8B 48 10 48 85 C9 75 1D 48 8B 00 81 78 18 53 C7 00 00 7E 71 0F 86 4F 01 00 00 38 88 73 C7 00 00 0F 95 C0 EB 0D 45 33 C0 BA 53 C7 00 00 E8 9C B6 40 02 84 C0 74 4F 33 D2 B9 53 C7 00 00 E8";
...
const SDK_UTIL_RSA_ENCRYPT: &str = "48 89 74 24 10 57 48 83 EC 20 48 8B 05 6F 29 60 05 48 8B F9 48 8B F2 48 8B 80 B8 00 00 00 48 8B 48 10 48 85 C9 75 21 48 8B 00 81 78 18 3F 2F 00 00 0F 8E AD 00 00 00 0F 86 4E 01 00 00 38 88 5F 2F 00 00 0F 95 C0 EB 0D 45 33 C0 BA 3F 2F 00 00";
...
const SECURITY_GET_PUBLIC_RSA_KEY: &str = "48 8B 05 A1 AE 1D 04 C3 CC CC CC CC CC CC CC CC 40 53 48 83 EC 20 48 8B D9 48 8B 0D A0 0A 09 04 83 B9 E0 00 00 00 00 75 05 E8 52 FC DD FA 48 8B 05 8B 0A 09 04 48 8B 90 B8 00 00 00 48 8B 4A 28 48 85 C9 0F 85 A5 00 00 00 48 8B 05 60 B4 06 04";
